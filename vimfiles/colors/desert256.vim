...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("Normal", "dddddd", "000000", "")
    ...
    call <SID>X("Comment","6688ee", "", "")
    call <SID>X("Constant", "dd0000", "", "")
    call <SID>X("Identifier","98fb98", "", "none")
    call <SID>X("Statement","cd9509", "", "bold")
    call <SID>X("PreProc", "cd5cac", "", "")
    call <SID>X("Type", "5eb91c", "", "bold")
